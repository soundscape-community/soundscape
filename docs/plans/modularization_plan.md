...
- Module extracted: `SoundscapeCoreDataStructures`.
...
- Package test target added:
  - `apps/common/Tests/SoundscapeCoreDataStructuresTests`.
- CI updated to run common boundary check + package tests before iOS build/test.

## Progress Updates
- 2026-02-06: Completed first extraction (`SoundscapeCoreDataStructures`) and integrated it into iOS target dependencies.
...
## Next Steps
1. Extract `SoundscapeCoreAuthorizations` into `apps/common` if imports can remain platform-neutral.
