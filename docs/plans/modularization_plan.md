...
- 2026-03-05: Latest dependency artifact exported: `20260305-044728Z-ssindex-7761111` (`latest.txt` now points to this report).
...
5. Prioritize cast-coalescing owner wiring (`((Registry.self as? DataContractRegistry.Type) ?? DataContractRegistry.self).spatial* = ...`) as the next concrete guardrail candidate.
...
- `docs/plans/artifacts/dependency-analysis/20260305-044728Z-ssindex-7761111.txt`
