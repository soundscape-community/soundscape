...
- `11` backend-ready files
- `6` mixed files that still combine persistence logic with runtime side effects
...
- `GDASpatialDataResultEntity.swift`: backend entity model only; debug quick-look runtime moved into an iOS extension
