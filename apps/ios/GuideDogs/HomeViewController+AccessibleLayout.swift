...
extension HomeViewController {
    ...
    private func configureSleepButton() {
        ...
        guard let sleepButton = sleepButton, let sleepIcon = sleepIcon else {
            return
        }
        ...
        // Increase minimum touch target if not already constrained
        let minTouchSize: CGFloat = 60
        if sleepButton.constraints.isEmpty {
